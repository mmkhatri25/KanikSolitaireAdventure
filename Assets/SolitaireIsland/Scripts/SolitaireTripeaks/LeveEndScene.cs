...
namespace SolitaireTripeaks
{
	public class LeveEndScene : BaseScene
	{
		...
		public void OnStart(LevelData levelData)
		{
            ...
            //else
            {
                ...
                if (levelData.StarComplete)
                {
                    ...
                    print("here game is completer.....star - "+ stars);
		...
		{
            print("OpenAnimator 111");
           
            //if (PlayerPrefs.HasKey("EndGame") && PlayerPrefs.GetInt("EndGame") == 1 && PlayerPrefs.HasKey("getstar") && PlayerPrefs.GetInt("getstar") == 1)
            //{
            //        SingletonClass<MySceneManager>.Get().Popup<TipPopupNoIconScene>("Scenes/Pops/TipPopupNoIcon").OnStart("Congrats!", "Finished all Levels.", "OK", delegate
            //        {
            ...
            { 
                ...
                taskQueueOnByoneUtility.Run(delegate
                {
                    ...
                    print("here I am ending...2");
                        
                        PlayerPrefs.SetInt("EndGame", 0);
                         
                    //    if(PlayerPrefs.HasKey("getstar") && PlayerPrefs.GetInt("getstar") == 1)
                    //    {
