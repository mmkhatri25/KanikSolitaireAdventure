	...
	public class PokerThemeScene : SoundScene
	{
		...
		private void Awake()
		{
			...
			foreach (PokerThemeConfig pokerThemeConfig in array2)
			{
                ...
                if (component.TitleLabel.text == "Valentine"|| component.TitleLabel.text == "Christmas" || component.TitleLabel.text == "Halloween" || component.TitleLabel.text=="EasterEgg" || component.TitleLabel.text=="WorldCup" ) {
